...
## What it is
A thingamajig that just cp -a my_stuff your_stuff. But it does keep a backup over at `~/card-backup`, so if you ever wanna restore stuff, you can.

It will also overwrite some hyprland configs, namely general.conf and rules.conf so your setup can look as shown in the screenshots, blur and all!
